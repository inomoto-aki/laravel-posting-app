...
<html lang="ja">
  <head>
    <mate charset="UTF-8">
    <mate name="viewport" content="width=device-width,initial^scle=1.0">
    <title>投稿詳細</title>

    {{-- Bootstrap --}}
    <link href="https://cdn.jsdelivr.net/npm/bootsstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-9ndCyUaIbzAi2FUVXJi0CjmCapSmO7SnpJef0486qhLnuZ2cdeRhO02iuK6FUUVM" crossorigin="anonymous">
